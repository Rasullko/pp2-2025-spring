...
class tools(pg.sprite.Sprite):
    def __init__(self, pic, position):
        super().__init__()
        self.pic = pg.image.load(f'lab8/paint/tools/{pic}')
...
items = [['eraser.jpg', (495, 20)], ['pen.jpg', (530, 20)], ['rect.jpg', (565, 20)], ['circle.jpg', (600, 20)], ['square.jpg', (635, 20)],
        ['right_triangle.jpg', (670, 20)], ['eq_triangle.jpg', (705, 20)], ['rhombus.jpg', (740, 20)]]
...
while run:
    ...
    for tool in Tools:
        point = pg.mouse.get_pos()
        if tool.rect.collidepoint(point) and pg.MOUSEBUTTONDOWN:
            if 'eraser' in items[k][0]:
                FigureMode = pen = False 
